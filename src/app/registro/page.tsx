  ...
  return (
    <main className="relative min-h-screen w-full flex items-center justify-center overflow-hidden px-6 bg-black">
      ...
      <div className="relative z-10 w-full max-w-[450px] flex flex-col items-center text-center space-y-8 animate-in fade-in zoom-in-95 duration-700 py-12">
        ...
        <Button onClick={() => router.push('/')} variant="outline" className="w-full h-12 bg-white hover:bg-white/90 text-black border-none rounded-xl flex items-center justify-center gap-3 transition-all active:scale-[0.98]">
          ...
          <span className="font-bold text-sm">Cuenta de Google</span>
        </Button>
