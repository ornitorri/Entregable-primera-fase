...
('Marco Dorado', 'Marco dorado elegante para tu avatar', '/uploads/rewards/gold-frame.svg', 200, 'frame'),
('Marco Plateado', 'Marco plateado para tu perfil', '/uploads/rewards/silver-frame.svg', 120, 'frame'),
